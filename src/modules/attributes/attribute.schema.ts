...
export const uuidParams = z.strictObject({ categoryId: z.uuid().optional(), attributeId: z.uuid().optional(), valueId: z.uuid().optional() });
...
export const createAttributeBody = z.strictObject({
  name: text(120),
  code,
  type: attributeType,
...
export const createValueBody = z.strictObject({
  value: code,
  label: text(120),
